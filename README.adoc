...
This repository is a fork of (https://github.com/hierynomus/sshj)[https://github.com/hierynomus/sshj] and introduces a few modifications which are not yet part of the original library:
